...
package com.election.US.basicsyncadapter.net;
...
public class FeedParser {
    ...
    private String readTitle(XmlPullParser parser, String tag)
            throws IOException, XmlPullParserException {
        parser.require(XmlPullParser.START_TAG, ns, tag);

        String titleraw = readText(parser);
        String title1 = titleraw.replace("<b>", "");
        String title2 = title1.replace("</b>","");
        String title3 = title2.replace("&#39;","'");
        String title = title3.replace("&quot;","'");
